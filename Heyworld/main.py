...
# agent =Agent(name="Assistant",instructions="You are a helpfull assistant")  #class
...
# result = Runner.run_sync(starting_agent=agent, input="tu jaa ray baba", run_config=config)
